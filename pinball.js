...
function createBackground(){
    for (let i = 0; i < screen.width + 1; i++){
   
        let menuBorder = document.createElement("div");
        menuBorder.style.width = String(i) + "px";
        menuBorder.style.height = String(i) + "px";
        let colorValue = 100000 + i*10;
        menuBorder.style.border = "1px solid #" + String(colorValue);
        menuBorder.style.position = "absolute";
        menuBorder.style.left = String(screen.width/2 - i/2) + "px";
        menuBorder.style.top = String(screen.height/2 - i/2) + "px";
        menuBorder.style.zIndex = 0;
        ...
        function colorChange(){
            setTimeout(function(){
                ...
                menuBorder.style.border = "1px solid #" + String(createHexValue(colorValue));
                if (inGame == false){
                colorChange()
                }
            },10)
        ...
        menuObjects.push(menuBorder);
        document.body.append(menuBorder);
...
function createHexValue(value){
    ...
    if((value / 16**5) > 0){
        v6 = convertHex(Math.floor((value / 16**5)));
    } else {
        v6 = 0;
    }
    value = (value % 16**5);
    ...
    if((value / 16**4) > 0){
        v5 = convertHex(Math.floor((value / 16**4)));
    } else {
        v5 = 0;
    }
    value = (value % 16**4);
    ...
    if((value / 16**3) > 0){
        v4 = convertHex(Math.floor((value / 16**3)));
    } else {
        v4 = 0;
    }
    value = (value % 16**3);
    ...
    if((value / 16**2)> 0){
        v3 = convertHex(Math.floor((value / 16**2)));
    } else {
        v3 = 0;
    }
    value = (value % 16**2);
    ...
    if((value / 16) > 0){
        v2 = convertHex(Math.floor((value / 16)));
    } else {
        v2 = 0;
    }
    value = (value % 16);
    ...
    newValue = String(v6) + String(v5) + String(v4) + String(v3) + String(v2) + String(v1);
    return(newValue)
...
function startBattle(player1Class,player2Class){
    ...
    function trapperAttack(player){
        ...
        if (((player == 1) && (player1AttackVariable < 4)) || (player == 2) && (player2AttackVariable < 4)){
        ...
        fieldObjects.push(trap);
        checkTraps();

        } 
        else if (((player == 1) && (player1AttackVariable == 4)) || (player == 2) && (player2AttackVariable == 4)){
            if(player == 1){
                player1AttackVariable = 5;
            }
            if(player == 2){
                player2AttackVariable = 5;
            }
        }
    function checkTraps(){
        let checking = 0;
        ...
        if(isNoIdColide(trap,"stage") == false){
            ...
            if (((player == 2) && (player2AttackVariable == 4)) || ((enemy == "player1") && (isNoIdColide(trap,enemy)))){
            ...
            if (((player == 1) && (player1AttackVariable == 4))|| ((enemy == "player2") && (isNoIdColide(trap,enemy)))){
                trap.style.height = "50px";
                trapTop -= 40;
                trap.style.top = trapTop + "px";
                player1AttackVariable -= 1;
    ...
    function endGame(){
        ...
        endScreen.style.width = String(screen.width/2) + "px";
        endScreen.style.height = String(screen.height/2) + "px";
        endScreen.style.left = String(screen.width/4) + "px";
        endScreen.style.top = String(screen.height/4) + "px";
        endScreen.style.position = "absolute";
        endScreen.style.background = "grey";
        endScreen.style.opacity = "0.5";
        endScreen.style.textAlign = "center";
        endScreen.style.fontSize = "80px";
        endScreen.style.zIndex = 10;    
        if (player1Lives == 0){
            endScreen.innerHTML = "Player 2 Wins!";
        }
        if (player2Lives == 0){
            endScreen.innerHTML = "Player 1 Wins!";
        }
        document.body.append(endScreen);

        let menuScreenButton = document.createElement("div");
        menuScreenButton.style.width = "300px";
        menuScreenButton.style.height = "100px";
        menuScreenButton.style.background = "green";
        menuScreenButton.style.opacity = "1";
        menuScreenButton.style.position = "absolute";
        menuScreenButton.style.left = String(screen.width * 1/2  - 150) + "px";
        menuScreenButton.style.top = String(screen.height / 2 - 50) + "px";
        menuScreenButton.style.border = "5px solid black";
        menuScreenButton.innerHTML = "<b>Back to Menu</b>";
        menuScreenButton.style.alignContent = "center";
        menuScreenButton.style.textAlign = "center";
        menuScreenButton.style.borderRadius = "20%";
        menuScreenButton.style.fontSize = "40px"
        menuScreenButton.style.zIndex = 10;
        document.body.append(menuScreenButton);

        menuScreenButton.onclick = function(){
        
        menuScreenButton.remove();
        endScreen.remove();
